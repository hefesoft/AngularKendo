(function () {
    ...
    angular.module('app').controller(controllerId, ['common', '$scope', 'datacontext', dashboard]);

    function dashboard(common, $scope, datacontext) {
